...
import fs.sicarius.cluster.web.filter.CachingHttpHeadersFilter;
import fs.sicarius.cluster.web.filter.StaticResourcesProductionFilter;
import fs.sicarius.cluster.web.filter.gzip.GZipServletFilter;
